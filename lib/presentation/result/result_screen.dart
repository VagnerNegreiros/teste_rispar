  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Obx(
          () => controller.visibilityDivider.value
              ? SizedBox(
                ...
                : Column(
                    children: [
                      ...
                      ItemListResult(
                          ...
                          result:
                              "${TextConstant.symbolBTC}${controller.simulationResponseModel.collateral}"),
                      ItemListResult(
                          text: TextConstant.interestRat,
                          result:
                              "${controller.simulationResponseModel.interestRate}${TextConstant.symbolBTCinterestRat}"),
                      ItemListResult(
                          text: TextConstant.percentageWarrantyUpper,
                          result:
                              "${controller.simulationResponseModel.ltv}${TextConstant.symbolPercentage}"),
                      ItemListResult(
                          text: TextConstant.firstDueDate,
                          result: DateFormat("dd/MM/yyyy").format(controller
                              .simulationResponseModel.firstDueDate!)),
                      ItemListResult(
                      ...
                      ItemListResult(
                          ...
                          result:
                              "${controller.simulationResponseModel.monthlyRate}${TextConstant.symbolPercentage}"),
                      ItemListResult(
                          text: TextConstant.cetAnnual,
                          result:
                              "${controller.simulationResponseModel.annualRate}${TextConstant.symbolPercentage}"),
                      ItemListResult(
